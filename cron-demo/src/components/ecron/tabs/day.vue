  ...
  <div class="config-list">
    <a-radio-group v-model="type">
      ...
      <div class="item">
        ...
        从<a-input-number :disabled="type!=TYPE_RANGE || disableChoice" :max="maxValue" :min="minValue" :precision="0"
                         class="w60" v-model="valueRange.start" />日
        至<a-input-number :disabled="type!=TYPE_RANGE || disableChoice" :max="maxValue" :min="minValue" :precision="0"
                         class="w60" v-model="valueRange.end" />日
      </div>
      <div class="item">
        <a-radio value="TYPE_LOOP" class="choice" :disabled="disableChoice">循环</a-radio>
        从<a-input-number :disabled="type!=TYPE_LOOP || disableChoice" :max="maxValue" :min="minValue" :precision="0"
      ...
      <div class="item">
        ...
        本月<a-input-number :disabled="type!=TYPE_WORK || disableChoice" :max="maxValue" :min="minValue" :precision="0"
        ...
        <div class="list">
          <a-checkbox-group v-model="valueList">
            <a-checkbox class="list-check-item" v-for="i in maxValue"
                        :value="i" :key="`key-${i}`" :disabled="type!=TYPE_SPECIFY || disableChoice">
              {{i}}
            </a-checkbox>
          </a-checkbox-group>
        </div>
